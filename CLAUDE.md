...
ASIC_FINANCIAL_ADVISERS · ASIC_AFS_LICENSEE · ASIC_AFS_AUTH_REP · ASIC_CREDIT_LICENSEE · ASIC_BANNED_PERSONS · ASIC_BANNED_ORGS · ASIC_LIQUIDATOR · ASIC_COMPANIES · ASIC_BUSINESS_NAMES · ASIC_CREDIT_REPRESENTATIVE · ASIC_AUDITORS · ASIC_SHORT_POSITIONS
...
source_url         https://data.gov.au/dataset/?organisation=australian-securities-investments-commission
...
uvx --refresh --from asic-mcp==<ver> python -c "..."         # smoke a published wheel
```
